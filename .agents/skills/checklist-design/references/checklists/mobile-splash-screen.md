...
### Brand background
A solid or subtly branded background that makes the transition from the  mobile home screen clear

### Launch duration
The splash visible only for as long as the app genuinely needs to initialise (not used as decorative padding)

### Transition to first screen
A smooth, intentional animation into the first real screen, ideally not a hard cut or jarring flash

### No interactive elements
The splash screen contains no buttons, inputs, or tappable areas, it is purely for transition
