...
_Tip: Copy should be clear and concise, focusing on a status or action_
...
_Tip: Example: A green toast informing success, red toast informing error. If informing a status, don't rely on just color and leverage icons or the copy._
...
_Tip: Read the text out loud slowly to gauge how much time is needed_
