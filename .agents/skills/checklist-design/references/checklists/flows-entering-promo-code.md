...
Source: https://www.checklist.design/flows/entering-promo-code
...
The change can be reflected using your success state colors (likely green) to indicate the code was applied. In the example is two different options, divided by how much information you want to show. For both, hiding the input field altogether makes it clear only one code can be entered.

### Reflect promo code impact
This can be shown with the promo code entry as a total amount, or be represented on In item-to-item basis. It's important to also show or at least repeat the discount near the total at checkout.
